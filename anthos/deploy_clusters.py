...
for f in files:
  os.system("sed -i 's/__DNS_SERVER__/{}/g' {}{}".format(gateway_ip, filepath, f))
  os.system("sed -i 's/__NETMASK__/{}/g' {}{}".format(subnet_mask, filepath, f))
  os.system("sed -i 's/__GATEWAY__/{}/g' {}{}".format(gateway_ip, filepath, f))
  os.system("sed -i 's/__ADMIN_LB_1_IP__/{}/g' {}{}".format(admin_lb_1_ip, filepath, f))
  os.system("sed -i 's/__ADMIN_LB_2_IP__/{}/g' {}{}".format(admin_lb_2_ip, filepath, f))
  os.system("sed -i 's/__DNS_SERVER__/{}/g' {}{}".format(gateway_ip, filepath, f))
  os.system("sed -i 's/__NETMASK__/{}/g' {}{}".format(subnet_mask, filepath, f))
  os.system("sed -i 's/__GATEWAY__/{}/g' {}{}".format(gateway_ip, filepath, f))
  os.system("sed -i 's/__USER_LB_1_IP__/{}/g' {}{}".format(user_lb_1_ip, filepath, f))
  os.system("sed -i 's/__USER_LB_2_IP__/{}/g' {}{}".format(user_lb_2_ip, filepath, f))
  os.system("sed -i 's/__ADMIN_LB_VIP__/{}/g' {}{}".format(admin_lb_vip, filepath, f))
  os.system("sed -i 's/__ADMIN_K8S_API_VIP__/{}/g' {}{}".format(admin_k8s_api_vip, filepath, f))
  os.system("sed -i 's/__ADMIN_K8S_INGRESS_VIP__/{}/g' {}{}".format(admin_k8s_ingress_vip, filepath, f))
  os.system("sed -i 's/__ADMIN_K8S_ADDON_VIP__/{}/g' {}{}".format(admin_k8s_addon_vip, filepath, f))
  os.system("sed -i 's/__USER_LB_VIP__/{}/g' {}{}".format(user_lb_vip, filepath, f))
  os.system("sed -i 's/__USER_K8S_API_VIP__/{}/g' {}{}".format(user_k8s_api_vip, filepath, f))
  os.system("sed -i 's/__USER_K8S_INGRESS_VIP__/{}/g' {}{}".format(user_k8s_ingress_vip, filepath, f))
